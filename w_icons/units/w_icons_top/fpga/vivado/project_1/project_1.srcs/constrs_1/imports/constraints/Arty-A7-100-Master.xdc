...
create_clock -add -name clk_ref_pin -period 10.00 -waveform {0 5} [get_ports { CLK_REF_I }];
#create_generated_clock -name CLK_REC_O -source [get_ports CLK_REF_I] -divide_by 3 [get_nets  i_common_clkdiv_by_n_top/clkdiv_n_regCLK_REC_O_OBUF]
#create_generated_clock -name "G_REFCLK_5MHZ" -divide_by 8     -source [get_nets i_common_clkdiv_by_n_top/clkdiv_n_regCLK_REC_O_OBUF]   [get_pins i_w_icons_mgmt/i_common_clkdiv_by_n/clk_stim_o] 
#create_generated_clock -name "G_REFCLK_1MHZ" -divide_by 32    -source [get_nets i_common_clkdiv_by_n_top/clkdiv_n_regCLK_REC_O_OBUF]   [get_pins i_w_icons_mgmt/i_common_clkdiv_by_n_discharge/clk_disacharge_o]
create_generated_clock -name CLK_REC_O -source [get_ports {CLK_REF_I}] [get_pins {i_common_clkdiv_by_n_top/clkdiv_n_reg/Q}] -divide_by 3
#create_generated_clock -name G1_REFCLK_5MHZ -source [get_pins {i_common_clkdiv_by_n_top/clkdiv_n_reg/Q}] [get_pins {i_w_icons_core/i_w_icons_mgmt/i_common_clkdiv_by_n/clkdiv_n_reg/Q}] -divide_by 8
#create_generated_clock -name G2_REFCLK_5MHZ -source [get_pins {i_common_clkdiv_by_n_top/clkdiv_n_reg/Q}] [get_pins {i_w_icons_core/i_w_icons_mgmt/i_common_clkdiv_by_n/clkdiv_p_reg/Q}] -divide_by 8
#create_generated_clock -name G1_REFCLK_1MHZ -source [get_pins {i_common_clkdiv_by_n_top/clkdiv_n_reg/Q}] [get_pins {i_w_icons_core/i_w_icons_mgmt/i_common_clkdiv_by_n_discharge/clkdiv_n_reg/Q}] -divide_by 32
#create_generated_clock -name G2_REFCLK_1MHZ -source [get_pins {i_common_clkdiv_by_n_top/clkdiv_n_reg/Q}] [get_pins {i_w_icons_core/i_w_icons_mgmt/i_common_clkdiv_by_n_discharge/clkdiv_p_reg/Q}] -divide_by 32
...
## Buttons
#set_property -dict { PACKAGE_PIN D9    IOSTANDARD LVCMOS33 } [get_ports { RESET_N_I }]; #IO_L6N_T0_VREF_16 Sch=btn[0]
#set_property -dict { PACKAGE_PIN C9    IOSTANDARD LVCMOS33 } [get_ports { btn[1] }]; #IO_L11P_T1_SRCC_16 Sch=btn[1]
#set_property -dict { PACKAGE_PIN B9    IOSTANDARD LVCMOS33 } [get_ports { btn[2] }]; #IO_L11N_T1_SRCC_16 Sch=btn[2]
#set_property -dict { PACKAGE_PIN B8    IOSTANDARD LVCMOS33 } [get_ports { btn[3] }]; #IO_L12P_T1_MRCC_16 Sch=btn[3]

## Pmod Header JA
# Serial Ports: maybe pull-up required for SPI_CLK_I
set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { SPI_CLK_I }]; #IO_0_15 Sch=ja[1]
create_clock -add -name clk_spi_pin -period 100 -waveform {0.0 50} [get_ports { SPI_CLK_I }];
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets SPI_CLK_I_IBUF]

#set_clock_groups -name "clock_groups_REFCLK_G_REFCLK_5MHZ_G_REFCLK_1MHZ_to_SPICLK" -asynchronous -group [list \
#  [get_clocks CLK_REC_O]  \
#  [get_clocks G_REFCLK_5MHZ]  \
#  [get_clocks clk_ref_pin]  \
#  [get_clocks G_REFCLK_1MHZ] ] -group [get_clocks clk_spi_pin]
...
#set_input_delay -clock [get_clocks clk_spi_pin] -add_delay 20.0 [get_ports SPI_CS_I]
#set_input_delay -clock [get_clocks clk_spi_pin] -add_delay 20.0 [get_ports SPI_CS_I]
#set_input_delay -clock [get_clocks clk_spi_pin] -add_delay 70.0 [get_ports SPI_MOSI_I]
#set_input_delay -clock [get_clocks clk_spi_pin] -add_delay 70.0 [get_ports SPI_MOSI_I]
#set_output_delay -clock [get_clocks clk_spi_pin] -add_delay 20.0 [get_ports SPI_MISO_O]
#set_output_delay -clock [get_clocks clk_spi_pin] -add_delay 20.0 [get_ports SPI_MISO_O]
#set_input_delay -clock [get_clocks CLK_REC_O] -add_delay 13.5135 [get_ports STIM_XEN_I]
#set_input_delay -clock [get_clocks CLK_REC_O] -add_delay 13.5135 [get_ports STIM_XEN_I]
#set_output_delay -clock [get_clocks CLK_REC_O] -add_delay 13.5135 [get_ports ADC1_OUT_O]
#set_output_delay -clock [get_clocks CLK_REC_O] -add_delay 13.5135 [get_ports ADC1_OUT_O]
#set_output_delay -clock [get_clocks CLK_REC_O] -add_delay 13.5135 [get_ports ADC2_OUT_O]
#set_output_delay -clock [get_clocks CLK_REC_O] -add_delay 13.5135 [get_ports ADC2_OUT_O]
#set_output_delay -clock [get_clocks CLK_REC_O] -add_delay 13.5135 [get_ports ADC_EN_O]
#set_output_delay -clock [get_clocks CLK_REC_O] -add_delay 13.5135 [get_ports ADC_EN_O]
#set_output_delay -clock [get_clocks CLK_REC_O] -add_delay 13.5135 [get_ports ERR_CRC_O]
#set_output_delay -clock [get_clocks CLK_REC_O] -add_delay 13.5135 [get_ports ERR_CRC_O]
#set_output_delay -clock [get_clocks CLK_REC_O] -add_delay 13.5135 [get_ports ERR_STIM_O]
#set_output_delay -clock [get_clocks CLK_REC_O] -add_delay 13.5135 [get_ports ERR_STIM_O]
