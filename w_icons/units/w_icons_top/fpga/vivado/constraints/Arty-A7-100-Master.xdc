...
create_clock -add -name clk_ref_pin -period 32.00 -waveform {0 16} [get_ports { CLK_REF_I }];
...
create_clock -add -name clk_spi_pin -period 100.00 -waveform {0 50} [get_ports { SPI_CLK_I }];
